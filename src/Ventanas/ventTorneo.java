package Ventanas;
public class ventTorneo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        iconoTorneo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/logoTorneo.png"))); // NOI18N
        ...
        etiquetaBienvenida.setText("Menú Torneo");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ventTorneo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ventTorneo().setVisible(true);
            }
        });
    }
