package Ventanas;
public class ventEquipo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        iconoTorneo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/logoEquipo.png"))); // NOI18N
        ...
        etiquetaBienvenida.setText("Menú Equipo");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ventEquipo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ventEquipo().setVisible(true);
            }
        });
    }
