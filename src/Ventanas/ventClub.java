package Ventanas;
public class ventClub extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        iconoTorneo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/logoClub.png"))); // NOI18N
        ...
        etiquetaBienvenida.setText("Menú Club");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ventClub.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
